...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in books_database/books_database_pb2_grpc.py depends on'
...
class BooksDatabaseStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTransactionStatus = channel.unary_unary(
                '/books_database.BooksDatabase/GetTransactionStatus',
                request_serializer=books__database_dot_books__database__pb2.GetTransactionStatusRequest.SerializeToString,
                response_deserializer=books__database_dot_books__database__pb2.GetTransactionStatusResponse.FromString,
                _registered_method=True)
...
def add_BooksDatabaseServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetTransactionStatus': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=books__database_dot_books__database__pb2.GetTransactionStatusRequest.FromString,
                    response_serializer=books__database_dot_books__database__pb2.GetTransactionStatusResponse.SerializeToString,
            ),
    }
...
class BooksDatabase(object):
    ...
    def GetTransactionStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/books_database.BooksDatabase/GetTransactionStatus',
            books__database_dot_books__database__pb2.GetTransactionStatusRequest.SerializeToString,
            books__database_dot_books__database__pb2.GetTransactionStatusResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
