...
from . import order_queue_pb2 as order__queue__pb2
...
class OrderQueueServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetQueueSize = channel.unary_unary(
                ...
                request_serializer=order__queue__pb2.GetQueueSizeRequest.SerializeToString,
                response_deserializer=order__queue__pb2.GetQueueSizeResponse.FromString,
                )
        self.PeekOrder = channel.unary_unary(
                '/order_queue.OrderQueueService/PeekOrder',
                request_serializer=order__queue__pb2.PeekOrderRequest.SerializeToString,
                response_deserializer=order__queue__pb2.PeekOrderResponse.FromString,
                )
...
def add_OrderQueueServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetQueueSize': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=order__queue__pb2.GetQueueSizeRequest.FromString,
                    response_serializer=order__queue__pb2.GetQueueSizeResponse.SerializeToString,
            ),
            'PeekOrder': grpc.unary_unary_rpc_method_handler(
                    servicer.PeekOrder,
                    request_deserializer=order__queue__pb2.PeekOrderRequest.FromString,
                    response_serializer=order__queue__pb2.PeekOrderResponse.SerializeToString,
            ),
    }
...
class OrderQueueService(object):
    ...
    def GetQueueSize(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/order_queue.OrderQueueService/GetQueueSize',
            order__queue__pb2.GetQueueSizeRequest.SerializeToString,
            order__queue__pb2.GetQueueSizeResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def PeekOrder(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/order_queue.OrderQueueService/PeekOrder',
            order__queue__pb2.PeekOrderRequest.SerializeToString,
            order__queue__pb2.PeekOrderResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
